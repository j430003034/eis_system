                        ...
                        <div v-for="order in orders">
                            <div v-if="order.confirmedState == orderState">
                                <card style="margin-top:10px;">
                                    ...
                                    <card style="margin-top:5px; background-color:#e5eff2" :bordered="false" :dis-hover="true">
                                    ...
                                    <Row style="height:20px;line-height:20px; margin-top:10px; margin-bottom:20px; text-align: center">
                                        <Col span="4">
